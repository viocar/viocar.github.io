const subheaderobj = {
	...
	"6":"Field effect",
	"8":"DMG % (If ailment)",
	"9":"DMG % (If ailment)", //how does this differ from 8?
	"11":"Lifesteal %",
	"14":"If front",
	"15":"If back",
	"18":"Swap row on hit (?)",
...
const textheaders = ["Max level","Skill type","Body part","Target req","Target Type","Target Team","Where Use","Buff/Debuff","B/D type","Unknown","B/D element","DMG element","ACureorInf","Ailment","Skill fl","Unknown 2"]; //I don't like this. I should rewrite it as an object probably
